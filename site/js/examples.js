...
var modalData = {
  ...
  'shop-cart': {
    ...
    body: '<p>Experiência de checkout otimizada para maximizar conversões.</p>' +
          '<ul><li>Cálculo de frete automático</li><li>Boleto, PIX, cartão de crédito</li><li>Cupons de desconto</li><li>Carrinho salvo entre sessões</li><li>Recuperação de carrinho abandonado</li></ul>'
  },
  'site-landing': {
